...
import com.mobi.ripple.core.data.data_source.remote.post.dto.asUploadCommentRequest
...
class PostRepositoryImpl(
    ...
    override suspend fun uploadComment(postId: String, comment: UploadComment): Response<Boolean?> {
        val apiResponse = postApiService.uploadComment(postId, comment.asUploadCommentRequest())
